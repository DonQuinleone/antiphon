...
const DEFAULT_BINDINGS: &[(Context, Action, &str)] = &[
    ...
    (Context::SettingsAccounts, Action::ReorderUp, "K"),
    (Context::SettingsAccounts, Action::AccountAdd, "a"),
    (Context::SettingsAccounts, Action::AccountEdit, "e"),
    (Context::SettingsAccounts, Action::DeleteAccount, "d"),
    (Context::SettingsAccounts, Action::SignIn, "o"),
    (Context::SettingsAccounts, Action::Revoke, "x"),
    (Context::SettingsAccounts, Action::NextTab, "tab"),
    (Context::SettingsAccounts, Action::PrevTab, "backtab"),
    (Context::SettingsAccounts, Action::SettingsClose, "esc"),
    (Context::SettingsEssentials, Action::SettingCycleNext, "l"),
    (
        Context::SettingsEssentials,
        Action::SettingCycleNext,
        "enter",
    ),
    (Context::SettingsEssentials, Action::SettingCyclePrev, "h"),
    (Context::SettingsEssentials, Action::NextTab, "tab"),
    (Context::SettingsEssentials, Action::PrevTab, "backtab"),
    (Context::SettingsEssentials, Action::SettingsClose, "esc"),
    (Context::SettingsFolders, Action::ReorderDown, "J"),
    (Context::SettingsFolders, Action::ReorderUp, "K"),
    (Context::SettingsFolders, Action::FolderHide, "h"),
    (Context::SettingsFolders, Action::FolderUnsync, "u"),
    (Context::SettingsFolders, Action::EditAlias, "enter"),
